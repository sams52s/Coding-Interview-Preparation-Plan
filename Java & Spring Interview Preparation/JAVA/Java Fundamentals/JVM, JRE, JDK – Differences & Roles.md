# ☕ JVM, JRE, JDK – Differences, Roles & Execution Flow
...
- **Bytecode Verifier** – ensures security and correctness
- **Execution Engine** – interprets or compiles bytecode (JIT)
...
> ❗ You cannot compile Java code with JRE. It's meant only for **execution**.
...
> ✅ Developers install JDK. End-users only need JRE to run apps.
...
1. **Compilation**:
   - `.java` source code → compiled using `javac` → `.class` bytecode
...
> 🧠 JIT compiler converts hot spots into machine code for faster performance.
...
### 🔹 Class Loading Process in Detail
...
- ❓ **Why is Java platform-independent but JVM platform-dependent?**
...
- ❓ **Explain the difference between interpreter and JIT compiler in JVM.**
...
- ❓ **What is the use of the method area in JVM?**
...
- ❓ **What is the difference between stack and heap memory in JVM?**
...
- ❓ **What is PermGen space and why was it replaced with Metaspace?**
...
- ❓ **Explain the Java class loader hierarchy.**
...
- ❓ **What happens if you run a Java class without JDK?**
...
- ❓ **How is garbage collection managed in the JVM?**
...
- ❓ **What is bytecode verification and why is it important?**
...
- ❓ **What causes a java.lang.OutOfMemoryError?**
...
- ❓ **How can you diagnose and fix memory leaks in Java applications?**
...
- ❓ **What is the difference between Serial, Parallel, CMS, and G1 garbage collectors?**
...
- ❓ **What is the purpose of JVM safepoints?**
...
- ❓ **What are some key JVM tuning parameters for high-performance applications?**
...
- ❓ **Explain the concept of JVM warm-up and why it's important in production systems.**
